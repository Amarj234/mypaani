...
import 'autootpcust.dart';

class costregister extends StatefulWidget {
  const costregister({Key? key}) : super(key: key);

  @override
  _costregisterState createState() => _costregisterState();
}

class _costregisterState extends State<costregister> {
  ...
  void _sendDataToSecondScreen() {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => autoOtp2(name1: Name1,mobile1:mobile1,email1:email1,address1:address1,piccode1:piccode1),
        ));
  }
